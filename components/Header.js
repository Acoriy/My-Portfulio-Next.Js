              ...
              {/* logo  */}
               <Link href={'/'}>
                  <div
                   ...
                   >
                    <h1 ><span className="font-bold text-3xl font-sora tracking-widest">Sofyane</span> 
                       <span className="ml-[10px] text-3xl font-extralight font-sora tracking-wider">Acoriy</span>
